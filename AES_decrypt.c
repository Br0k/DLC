...
void KeyExpansion(unsigned char* key, unsigned char* keys, int Nk, int Nr){
    uint8_t tmp[4];
    int k;
...
void AES_decrypt(unsigned char* key, unsigned char* cipher, int lenKey, int lenCipher) {
	...
	*/
    ...
    sprintf((char*)tmp, "round[%2d].ioutpt", compteur);
    affichage(tmp, lentravail, travail);
...
int main(int argc, char **argv) {
    ...
    AES_decrypt(key, cipher, lenKey, lenCipher);
    return 0;
}